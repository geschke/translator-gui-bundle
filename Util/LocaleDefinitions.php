...
/**
 * Class LocaleDefinitions
 * Taken from WordPress Codestyling Localization Plugin
 * https://wordpress.org/plugins/codestyling-localization/
 *
 * @package Geschke\Bundle\Admin\TranslatorGUIBundle\Util
 */
class LocaleDefinitions
{
    public static $csp_l10n_langs = array(
        'af' => array('af_AF'),
        'ar' => array(
            'ar_AE',
            'ar_BH',
    ...
    public static $csp_l10n_login_label = array(
        'af' => "Taal",
        'ar' => "لغة",
        'az' => "Dil",
        'be' => "МО́ВА",
...
//based on http://translate.sourceforge.net/wiki/l10n/pluralforms
    public static $csp_l10n_plurals = array(
    ...
    public static $csp_l10n_sys_locales = array(
        'af_AF' => array(
